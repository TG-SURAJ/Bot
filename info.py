...
BOT_TOKEN = environ.get('BOT_TOKEN', "5312771340:AAH3-_aaU8i9e2vRygSvlzuP94ulAQSIPtU")
...
reqst_channel = environ.get('-1001659583578')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b>📂 Fɪʟᴇ ɴᴀᴍᴇ : </b> <code>{file_caption}</code>
